...
CHARTS := edge-apiserver edge-console edge-controller edge-monitoring edge-duty kubeedge vcluster yurt-manager yurthub vast vcluster-k8s-addition yurt-iot-dock iot-apiserver iot-controller
