...
CHARTS := edge-apiserver edge-console edge-controller edge-monitoring edge-duty edge-ota kubeedge vcluster yurt-manager yurthub vast vcluster-k8s-addition yurt-iot-dock traefik
